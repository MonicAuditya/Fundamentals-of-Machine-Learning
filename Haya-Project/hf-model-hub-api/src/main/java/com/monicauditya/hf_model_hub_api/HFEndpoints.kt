...
class HFEndpoints {
    companion object {
        ...
        val getHFModelReadmeEndpoint: ((String) -> String) = { "$HF_BASE_URL/$it/raw/main/README.md" }

        val getHFModelResolveEndpoint: ((String, String) -> String) = { modelId, fileName ->
            "$HF_BASE_URL/$modelId/resolve/main/$fileName"
        }
    }
}
